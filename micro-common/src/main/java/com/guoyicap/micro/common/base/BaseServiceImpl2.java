...
import com.guoyicap.micro.common.exception.ValidationException;
...
public abstract class BaseServiceImpl2<T extends IdEntity> implements BaseService2<T> {
	...
	/*
	 * public BaseServiceImpl(Validator validator) { this.validator = validator; }
	 */
